...
(function ($, AdminLTE) {
  ...
  admin_settings.append("<h4 class='control-sidebar-heading'>主题</h4>");
  admin_settings.append(skins_list);

  tab_pane.append(admin_settings);
